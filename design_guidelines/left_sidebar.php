...
//  This is the function of the things
// ── Helpers ────────────────────────────────────────────────────────────────
...
// Foundation pages now live at /Foundation/{name}/{name}.php — keep basename list for active detection
?>
...
<nav class="sb-nav" id="sbNav">
  ...
  <div class="sb-group <?= $foundationOpen ? 'open' : '' ?>">
    ...
    <ul class="sb-items" <?= !$foundationOpen ? 'hidden' : '' ?>>
      ...
      <li><a href="/Foundation/colour/colour.php" class="sb-link <?= $current === 'colour.php' ? 'active' : '' ?>">
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
      ...
      <li><a href="/Foundation/typography/typography.php" class="sb-link <?= $current === 'typography.php' ? 'active' : '' ?>">
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
      ...
      <li><a href="/Foundation/spacing/spacing.php" class="sb-link <?= $current === 'spacing.php' ? 'active' : '' ?>">
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
      ...
      <li><a href="/Foundation/icons/icons.php" class="sb-link <?= $current === 'icons.php' ? 'active' : '' ?>">
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
      ...
      <li><a href="/Foundation/layout/layout.php" class="sb-link <?= $current === 'layout.php' ? 'active' : '' ?>">
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">

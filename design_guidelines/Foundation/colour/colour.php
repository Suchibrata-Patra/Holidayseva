...
<!-- COLOR THEORY -->
<hr class="page-rule"/>
<section id="theory" class="doc-section">
  <p class="section-label">Principles</p>
  <h2 class="section-title">Color theory</h2>
  <p class="section-body">Understanding how colors interact helps you make intentional, accessible choices that communicate meaning consistently across every surface.</p>
  <div class="theory-grid">
    <div class="theory-card">
      <div class="theory-card-visual" style="background:linear-gradient(135deg,#FF385C 0%,#FF9500 50%,#FFCC00 100%)"></div>
      <div class="theory-card-body">
        <p class="theory-card-title">Analogous harmony</p>
        <p class="theory-card-desc">Colors adjacent on the wheel (red → orange → yellow) create cohesive, low-tension palettes. Our primary-to-warning gradient uses this principle naturally.</p>
      </div>
    </div>
    <div class="theory-card">
      <div class="theory-card-visual" style="background:linear-gradient(90deg,#FF385C 50%,#00A699 50%)"></div>
      <div class="theory-card-body">
        <p class="theory-card-title">Complementary contrast</p>
        <p class="theory-card-desc">Primary red-pink (#FF385C) and teal accent (#00A699) sit opposite on the wheel — maximum visual tension, ideal for CTA vs. confirmation.</p>
      </div>
    </div>
    <div class="theory-card">
      <div class="theory-card-visual" style="display:flex">
        <div style="flex:1;background:#FF385C"></div>
        <div style="flex:1;background:#5856D6"></div>
        <div style="flex:1;background:#34C759"></div>
      </div>
      <div class="theory-card-body">
        <p class="theory-card-title">Triadic balance</p>
        <p class="theory-card-desc">Three evenly-spaced hues (primary, indigo, green) provide status differentiation without any color dominating — used across badge and alert states.</p>
      </div>
    </div>
    <div class="theory-card">
      <div class="theory-card-visual" style="background:linear-gradient(to right,#1D1D1F,#6E6E73,#B0B0B0,#F5F5F7)"></div>
      <div class="theory-card-body">
        <p class="theory-card-title">Neutral grounding</p>
        <p class="theory-card-desc">Chromatic colors gain power when grounded in a neutral scale. Our six-step gray ramp from <code>#1D1D1F</code> to <code>#F2F2F7</code> anchors every context.</p>
      </div>
    </div>
    <div class="theory-card">
      <div class="theory-card-visual" style="background:#fff;position:relative">
        <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:space-around;padding:0 20px">
          <div style="text-align:center"><div style="font-size:22px;font-weight:700;color:#1D1D1F">Aa</div><div style="font-size:10px;color:#999;margin-top:2px">16.1:1</div></div>
          <div style="text-align:center"><div style="font-size:22px;font-weight:700;color:#6E6E73">Aa</div><div style="font-size:10px;color:#999;margin-top:2px">4.6:1</div></div>
          <div style="text-align:center"><div style="font-size:22px;font-weight:700;color:#B0B0B0">Aa</div><div style="font-size:10px;color:#999;margin-top:2px">2.3:1 ✗</div></div>
        </div>
      </div>
      <div class="theory-card-body">
        <p class="theory-card-title">Contrast ratios (WCAG 2.1)</p>
        <p class="theory-card-desc">AA needs 4.5:1 for normal text, 3:1 for large. AAA needs 7:1. Primary and secondary text always meet AA; muted is decorative-only.</p>
      </div>
    </div>
    <div class="theory-card">
      <div class="theory-card-visual" style="position:relative;overflow:hidden;background:linear-gradient(135deg,#007AFF,#5856D6)">
        <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center">
          <div style="width:56px;height:56px;border-radius:14px;background:rgba(255,255,255,0.65);border:1px solid rgba(255,255,255,0.4);box-shadow:0 4px 16px rgba(0,0,0,0.12)"></div>
        </div>
      </div>
      <div class="theory-card-body">
        <p class="theory-card-title">Liquid Glass & vibrancy</p>
        <p class="theory-card-desc">Glass surfaces inherit color from content behind via <code>--color-glass-bg</code>. Add <code>--color-glass-tint</code> for brand emphasis on key controls.</p>
      </div>
    </div>
  </div>
</section>
